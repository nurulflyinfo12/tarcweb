...
export default function ReviewsPage() {
  // 1. TripAdvisor Reviews Data (Stacked Speech Bubble)
  ...
  const bookingReviews = [
    {
      id: 4,
      rating: 5,
      text: "- it's situated in a calm and quiet place.",
      author: "Fonseka",
      date: "1. November, 2023.",
    },
    {
  ...
  const facebookReviews = [
    ...
    },
    {
      id: 11,
      rating: 5,
      text: "Don't listen to the hype about other hotels! Others may be fun but class is something totally different! Absolutely wonderful week here with...",
      author: "Brent Timm",
      date: "1. November, 2023.",
    },
    {
      id: 12,
      rating: 5,
      text: "The Imperial Institute Of Hospitality & Hotel Management is very famous and wonderful resort to stay and visit to keep yourself away from the busyness of the city. Their...",
      author: "Jagdish Shekhawat",
      date: "1. November, 2023.",
    },
    {
      id: 13,
      rating: 5,
      text: "A classic stay at the hotel made my days filled with relaxation and calm during last winter when I was there for an official trip. The swimming pool an...",
      author: "Zahid",
      date: "1. November, 2023.",
    },
    {
      id: 14,
      rating: 5,
      text: "We are Bangladeshi's, a family of 5 adults who are residing overseas for...",
      author: "100 Percent Chiropractor",
      date: "100 Percent",
    },
    {
      id: 15,
      rating: 5,
      text: "The PERFECT resort. Everything here was incredible. First, the staff was amazing. So helpful, so caring and so attentive. The food served in the lunc...",
      author: "Brent Timm",
      date: "1. November, 2023.",
    },
    {
      id: 16,
      rating: 5,
      text: "Good for professional family.",
      author: "Arnim Bin Sayeed (Ar...",
      date: "Arnim Bin Sayeed (Arnim)",
    },
  ];

  const genericDescription =
    "The Imperial Institute Of Hospitality & Hotel Management is highly recommended as the top leisure destination by satisfied guests. It is equipped with luxurious facilities, serene environment, sumptuous cuisines and remarkable services that make the stay unforgettable. Guests have praised the resort for its excellent hospitality, comfortable rooms, cleanliness and accessibility to amenities.";
            ...
            <div className="relative z-10 bg-white rounded-2xl p-6 sm:p-10 shadow-2xl">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
                {bookingReviews.map((review) => (
                  <div
                    key={review.id}
                    className="w-full bg-white border border-neutral-100 rounded-2xl p-5 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex flex-col justify-between min-h-[220px]"
                  >
                    <div>
                    ...
                    <div>
                      <button className="text-[11px] text-neutral-400 font-medium hover:underline mb-3 block text-left">
                        Read more
                      </button>
                    ...
                    <div className="relative bg-neutral-50 rounded-2xl p-5 border border-neutral-100 shadow-sm after:content-[''] after:absolute after:-bottom-2 after:left-7 after:w-4 after:h-4 after:bg-neutral-50 after:border-r after:border-b after:border-neutral-100 after:rotate-45">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-1">
                          ...
                          <svg
                            className="w-3.5 h-3.5 text-blue-500 fill-current ml-0.5"
                            viewBox="0 0 24 24"
                          >
                      ...
                      <button className="text-[10px] text-neutral-400 font-medium hover:underline mt-2 block text-left">
                        Read more
                      </button>
                    </div>
            ...
            <div className="relative z-10 bg-white rounded-2xl p-6 sm:p-10 shadow-2xl">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 items-start">
                {facebookReviews.map((review) => (
                  <div
                    key={review.id}
                    className="w-full bg-white border border-neutral-200 rounded-lg p-5 flex flex-col justify-between min-h-[250px] shadow-[0_2px_8px_rgba(0,0,0,0.01)]"
                  >
                    <div>
                      <div className="flex items-center gap-3 mb-3">
                        <div className="w-9 h-9 rounded-full bg-sky-100 border border-sky-200 flex items-center justify-center shrink-0">
                          <svg
                            className="w-4 h-4 text-sky-600 fill-current"
                            viewBox="0 0 24 24"
                          >
                            <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
                          </svg>
                        ...
                        <div className="flex flex-col truncate">
                          <h4 className="text-xs font-bold text-sky-800 tracking-wide truncate">
                            {review.author}
                          </h4>
                      ...
                      <p className="text-xs text-neutral-700 leading-normal font-normal line-clamp-4">
                        {review.text}
                      </p>
                    </div>

                    <button className="text-[10px] text-neutral-400 font-medium hover:underline mt-3 block text-left">
                      Read more
                    </button>
                  </div>
                ))}
