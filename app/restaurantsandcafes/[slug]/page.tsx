                        ...
                        >
                            <div className="bg-[#5D7553] p-5 sm:p-6 md:p-8 rounded-xl text-white">
                                <ul className="space-y-5 text-sm sm:text-base md:text-lg">
                                    <li><span className="font-semibold">Cuisine:</span><br /><span className="opacity-90">{restaurant.cuisine.join(", ")}</span></li>
                                    <li><span className="font-semibold">Atmosphere:</span><br /><span className="opacity-90">{restaurant.atmosphere}</span></li>
                                    <li><span className="font-semibold">Service Style:</span><br /><span className="opacity-90">{restaurant.serviceStyle}</span></li>
                                    <li>
                                    ...
                                    <li><span className="font-semibold">Location:</span><br /><span className="opacity-90">{restaurant.location}</span></li>
                                </ul>
                            </div>
                        </motion.div>
                    </div>
