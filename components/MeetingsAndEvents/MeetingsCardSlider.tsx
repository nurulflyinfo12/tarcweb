  ...
  return (
    <div className="w-full py-6">
      ...
      <div className="relative w-full max-w-7xl mx-auto">
        ...
        <div
          className={`relative bg-white rounded-2xl p-6 sm:p-8 md:p-10 flex flex-col md:flex-row items-center gap-8 md:gap-12 shadow-xl border border-neutral-100/80 z-10 ${room.reverse ? "md:flex-row-reverse" : ""
            }`}
        >
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 z-10">
                  {room.images.map((_, idx) => (
                    <button
                      ...
                      className={`h-[3px] rounded-full transition-all duration-300 ${idx === currentIndex
                          ? "w-6 bg-neutral-800"
