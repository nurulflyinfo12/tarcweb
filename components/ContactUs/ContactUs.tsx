                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-2xl">
                            <div className="flex flex-col lg:flex-row">
                                ...
                                <div className="lg:w-5/12 p-6 sm:p-8 lg:p-5 space-y-6">
                                    ...
                                    <div className="bg-[#4F6240] rounded-sm p-6 sm:p-7 text-white">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="min-w-0">
                                                <h3 className="text-lg sm:text-xl font-semibold mb-3">Grand Sultan Tea Resort & Golf</h3>
                                                <p className="text-sm opacity-90">Srimongal, Moulvibazar - 3210, Bangladesh.</p>
                                                <div className="mt-4 space-y-1.5 text-sm">
                                                    <p><strong>Tel:</strong> +880 2997 738501-3</p>
                                                    <p><strong>For Reservation:</strong> +880 9678 785959 / +880 1730 793501-4</p>
                                                    <p><strong>For Corporate or Group Event:</strong> +880 1730 793555</p>
                                                    <p><strong>Email:</strong> reservations@grandsultanresort.com</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-[#4F6240] rounded-sm p-6 sm:p-7 text-white">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="min-w-0">
                                                <h3 className="text-lg sm:text-xl font-semibold mb-3">Corporate Office</h3>
                                                <p className="text-sm opacity-90">House# 108, Apt.# D2, Road 11, Block C, Banani, Dhaka 1213, Bangladesh.</p>
                                                <p className="mt-4 text-sm"><strong>Tel:</strong> +880 9678 762929</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-[#4F6240] rounded-sm p-6 sm:p-7 text-white">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="min-w-0">
                                                <h3 className="text-lg sm:text-xl font-semibold mb-3">Excursion & Resorts Bangladesh Ltd</h3>
                                                <p className="text-sm opacity-90">
                                                    Grand Sultan Tea Resort & Golf is a wholly owned subsidiary of Excursion & Resorts Bangladesh Ltd.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="lg:w-7/12 p-6 sm:p-8 lg:p-5 bg-white">
                                    <h2 className="text-2xl sm:text-3xl font-semibold text-[#0A2F1F] mb-8">We'd Love To Hear From You</h2>
